...
parser.add_argument('--lambda_cl', type=float, default=0.4, help='lambda of contrastive loss')
...
parser.add_argument('--t1', type=int, default="t for col")
parser.add_argument('--t2', type=int, default="t for geo")
parser.add_argument('--t3', type=int, default="t for trans")
...
def main():
    ...
    for epoch in range(args.num_epochs):
        ...
        for idx, batch in enumerate(train_dataloader):
            ...
            logging.info("Train. loss_rec: {:.4f}; loss_cl_pois: {:.4f}; "
                         "loss: {:.4f}".format(loss_rec.item(), loss_cl_pois, loss))
